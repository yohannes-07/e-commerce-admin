...
export const ProductForm :React.FC<ProductFormProps> = ({
    ...
    const description = initialData ? 'Edit a proudct' : 'Add a new product'
                    ...
                    render={({field}) => (
                        <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md p-4'>
                            ...
                            <div className='space-y-1 leading-none'>
                                ...
                                <FormDescription>This product willnot  appear anywhere on the store</FormDescription>
                            </div>
                        </FormItem>
                    )}   
                />
